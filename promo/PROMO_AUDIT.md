...
## Routes / screens used
- `audit/screenshots/final-ready/DriveWise/10-dashboard-real.png` → shown as `app.drivewise.si`
- `audit/screenshots/final-ready/DriveWise/11-trips-real.png` → shown as `app.drivewise.si/trips`
- Mobile: `audit/screenshots/final-ready/DriveWise/03-mobile.png`
...
- [x] Required disclaimer included: "MVP demo — scores are illustrative, not for insurance or legal use."

## Promo videos

**Generated:** 8 platform videos + 2 GIF fallbacks per project, via `build-videos.mjs`.
- `videos/01-instagram-reel.mp4` (3.8 MB)
- `videos/02-tiktok.mp4` (3.8 MB)
- `videos/03-youtube-short.mp4` (3.8 MB)
- `videos/04-linkedin-demo.mp4` (4.9 MB)
- `videos/05-x-demo.mp4` (3.4 MB)
- `videos/06-facebook-demo.mp4` (4.9 MB)
- `videos/07-github-readme-demo.mp4` (2.4 MB)
- `videos/08-portfolio-hero.mp4` (4.9 MB)
- `videos/gifs/github-readme-demo.gif` (4.1 MB)
- `videos/gifs/short-demo.gif` (7.1 MB)
...
**Screens/routes used:** Dashboard (Pregled), Trips (Vožnje) + mobile view.
